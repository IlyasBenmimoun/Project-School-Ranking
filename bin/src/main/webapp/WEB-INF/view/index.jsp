		...
		<div class="container">
			<div class="row mb-5">
				...
				<div class="col-lg-5 ml-auto">
					...
					<p>Accusantium dignissimos voluptas rem consequatur blanditiis
						error ratione illo sit quasi ut, praesentium magnam, pariatur
						quae, necessitatibus</p>
					<p>Dolor, eligendi voluptate ducimus itaque esse autem
						perspiciatis sint! Recusandae dolor aliquid inventore sit,</p>
					<p>Recusandae dolor aliquid inventore sit, maiores quisquam
						nostrum quaerat dolorum error rerum</p>
					<p>
						<a href="#">Read More</a>
					</p>
				</div>
									...
									<form action="/Login" method="post"
										...
										<div class="wrap-input100 validate-input m-b-23"
											...
											<span class="label-input100">Nom d'utilisateur</span> <input
												...
												placeholder="votre nom d'itulisateur" value="${user.username }" />
