...
<%@page import="com.RS.modal.Classement" %>
    <%List <Classement> classement=(List)request.getAttribute("viewinfo"); %>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="row align-items-center position-relative">
            ...
            <!-- <div class="col-12"> -->
              <nav class="site-navigation text-center ml-auto" role="navigation">
                ...
                <li><a href="/user" class="nav-link">Acceuil</a></li>
                <li><a href="#" class="nav-link">  Vos Information</a></li>
               <li><a href="/user" class="nav-link">Contactez-nous</a></li>
        ...
        <div class="row mb-5">
          <div class="col-12">
            <div class="block-heading-1">
              <h2>Voici votre information sur <%=classement.get(0).getNomEtablissement() %></h2>
            </div>
          </div>
          </div>
